...
var Lemmatizer = function (baseUrl = '') {
  this.wn_files = {
  ...
  for (let key in this.wn_files) {
    this.wn_files[key][0] = baseUrl + this.wn_files[key][0];
    this.wn_files[key][1] = baseUrl + this.wn_files[key][1];
  }
...
Lemmatizer.prototype = {
  ...
  only_lemmas: function (form, pos) {
    var result = _.map(this.lemmas(form, pos), function (val) {
      return val[0];
    });
