...
- index 是工具服务的入口，功能导出文件。UI 会调用这个文件使用功能。功能编排也会用到。index 的导出会包含 core、schema、types 等。

- core 是核心功能，不涉及多语言、UI 错误提示等。

- schema 是服务概要，实际上就是用一个对象表示服务提供的功能。该模块每个服务都要有，可以描述丰富，提供可编排功能，也可以只包含名称、图标、关键字、描述。
...
- worker 是多线程文件。可以被 core，schema 等使用。
